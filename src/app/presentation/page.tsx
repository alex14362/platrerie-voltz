  ...
  return (
    <>
      ...
      <section className="container reveal" style={{ padding: "40px 0" }}>
        <div className="panel reveal-stagger" style={{ padding: 36 }}>
          <div
          ...
          >
            <div>
              ...
              >
                Entreprise familiale fondée en 2016, nous intervenons dans tout le
                Bas-Rhin pour vos travaux de plâtrerie, d’isolation et
                d’aménagement intérieur. Fort d’une longue expérience dans le
                métier, Jean-Luc a consacré toute sa carrière à la plâtrerie,
                développant un véritable savoir-faire artisanal. Reconnu pour son
                travail minutieux et son souci du détail, Jean-Luc accorde une
                attention particulière à chaque chantier pour garantir un
        ...
        <div className="container" style={{ marginTop: 24 }}>
          <div className="panel reveal-stagger" style={{ padding: 24 }}>
            ...
            <p style={{ color: "var(--text-muted)", margin: 0 }}>Bas-Rhin et alentours.</p>
          </div>
        </div>
      </section>
    </>
